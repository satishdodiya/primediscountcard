...
<script src="https://use.fontawesome.com/6d5abead86.js"></script>
		<!--[if lte IE 9]>
				...
				<ul class="nav nav-list">
					...
					<li class="">
						<a href="fileupload.jsp">
							...
							<span class="menu-text">Upload Logo </span>
						</a>
					...
					<li class="">
						<a href="cardverify.jsp">
							<i class="menu-icon fa fa-id-card-o"></i>
							<span class="menu-text">Card Verify </span>
						</a>
