	...
	<div class="contact main-grid-border">
		<div class="container">
			...
			<section id="hire">
				<form id="filldetails" action="user/contactinsert.jsp" method="post">
					  <div class="field name-box">
							<input type="text" name="cname" placeholder="Who Are You?"/>
							<label>Name</label>
					  ...
					  <div class="field msg-box">
							<textarea id="msg" name="cmsg" rows="4" placeholder="Your message goes here..."></textarea>
