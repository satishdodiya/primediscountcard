	<%@ include file="header.jsp" %>
	 ...
	 <section>
		<div id="agileits-sign-in-page" class="sign-in-wrapper">
			...
			<h3>Sign In</h3>
				<form action="user/partnerlogin.jsp" method="Post">
					<input type="email" name="lemail" placeholder="Your Email" required=""> 
				...
				<h6> Not a Member Yet? <a href="Recommend-a-Merchant.jsp">Sign Up Now</a> </h6>
			</div>
		</div>
	</section>
